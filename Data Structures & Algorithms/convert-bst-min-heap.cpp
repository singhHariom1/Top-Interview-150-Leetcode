...
// Function to perform inorder traversal of BST and store the node values in a vector
...
// Function to perform preorder traversal of the tree and copy the values from the inorder array to nodes
